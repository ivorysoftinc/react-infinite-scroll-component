var InfiniteScroll = (function(React) {
  ...
  var InfiniteScroll = /** @class */ (function(_super) {
    ...
    function InfiniteScroll(props) {
      ...
      _this.onStart = function(evt) {
        ...
        if (_this._infScroll) {
          ...
          _this._infScroll.style.transition =
      ...
      _this.onMove = function(evt) {
        ...
        if (_this._infScroll) {
          ...
          _this._infScroll.style.transform =
            'translate3d(0px, ' + (_this.currentY - _this.startY) + 'px, 0px)';
        }
      };
      ...
      _this.onScrollListener = function(event) {
        ...
        var target =
          _this.props.height || _this._scrollableNode
            ? event.target
      ...
      _this.throttledOnScrollListener = throttle(
        150,
    ...
    InfiniteScroll.prototype.UNSAFE_componentWillReceiveProps = function(
      props
    ) {
    ...
    InfiniteScroll.prototype.isElementAtTop = function(
      target,
      scrollThreshold
    ) {
    ...
    InfiniteScroll.prototype.isElementAtBottom = function(
      target,
      scrollThreshold
    ) {
      if (scrollThreshold === void 0) {
